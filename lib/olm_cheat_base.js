// ============================================
// OLM.VN QUIZ CHEAT TOOL V4 - FINAL EDITION
// ============================================
...
(function() {
    ...
    const CONFIG = {
        ...
        groqVisionModel: 'meta-llama/llama-4-maverick-17b-128e-instruct',
        debugMode: true,
    ...
    // ============================================
    // TIME CONTROL - SIMPLE STOP BUTTON
    // ============================================
    ...
    function toggleStop() {
        ...
        if (isTimerStopped) {
            // STOP - Clear all intervals and block new ones
            ...
            // START - Reload page to restart everything
            log(' RELOADING PAGE...', '#00ff00');
            log('⚠️ IMPORTANT: After reload, you need to PASTE THE SCRIPT AGAIN!', '#ffff00');
            log('⚠️ The UI will disappear after reload - this is normal!', '#ffff00');
    ...
    function updateToggleUI() {
        ...
        if (pauseToggle) {
            pauseToggle.checked = CONFIG.isPaused;
        }
        if (speedToggle) {
            speedToggle.checked = CONFIG.is5x;
        }
    }
